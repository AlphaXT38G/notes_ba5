...
\begin{itemize}
    ...
    \item \textbf{ReLU :} $\sigma(z) = \max(0, z)$ -- la plus utilisée dans les couches cachées.
\end{itemize}
\end{defnbox}
...
On définit la sensibilité de la loss à la pré-activation du neurone $(k,l)$ avec $\ell_i$ la loss du sample $i$:
