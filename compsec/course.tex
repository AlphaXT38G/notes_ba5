...
\textbf{Properties} of a computer system must hold in the presence of a
\textbf{resourced strategic adversary}.
\end{defnbox}
...
\textbf{isolation}, \textbf{non-repudiation}, and more.
\end{rembox}
...
\begin{tabular}{lll}
Confidentiality & prevent unauthorized disclosure & authorized \textbf{users} may read a \textbf{file} \\
Integrity & prevent unauthorized modification & authorized \textbf{programs} may write a \textbf{file} \\
Availability & prevent unauthorized denial of service & authorized \textbf{services} can access a \textbf{file} \\
\end{tabular}
\end{propbox}
